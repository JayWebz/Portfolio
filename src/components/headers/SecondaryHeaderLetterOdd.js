...
class SecondaryHeaderOdd extends Component {
	constructor(props) {
		super(props);
		this.state = {
			hover: false
	...
	render() {
		return(
			<div className="heading-secondary__letter-container">
				...
				<span className={`heading-secondary__letter heading-secondary__letter ${this.state.hover ? "heading-secondary__letter-animate" : ""}`}
...
export default SecondaryHeaderOdd;